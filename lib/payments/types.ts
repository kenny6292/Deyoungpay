...
export interface PaymentResult { provider:PaymentProvider; providerReference:string; status:PaymentStatus; amountMinor:number; currency:Currency; checkoutUrl?:string; accessCode?:string; }
